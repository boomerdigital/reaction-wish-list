...
2. `git clone git@github.com:reaction-contrib/meteor-braintree.git`
3. `reaction reset`
...
Based on the accepted payment methods, Braintree's default schema for credit card numbers will allow between 12 - 19 numbers. This can be changed in `<reaction-root>/imports/plugins/custom/meteor-braintree/lib/collections/schemas/package.js` depending on your needs.
