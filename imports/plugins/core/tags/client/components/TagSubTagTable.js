...
/**
 * @file TagSubTagTable is a React Component wrapper around {@link https://react-table.js.org} ReactTable.
 ...
 * @returns {Class} class
 */
class TagSubTagTable extends Component {
  constructor(props) {
    super(props);
...
registerComponent("TagSubTagTable", TagSubTagTable);

export default TagSubTagTable;
